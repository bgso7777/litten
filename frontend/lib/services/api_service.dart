...
class ApiService {
  ...
  static const String _loginMobileEndpoint = '/litten/note/v1/members/login/mobile';
  ...
  Future<Map<String, dynamic>> registerUuid({
    ...
    try {
      ...
      debugPrint('[ApiService] registerUuid - Response status: ${response.statusCode}');
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        debugPrint('[ApiService] registerUuid - Failed: ${response.statusCode}');
  ...
  Future<Map<String, dynamic>> loginWeb({
    ...
    try {
      ...
      debugPrint('[ApiService] loginWeb - Response status: ${response.statusCode}');
  ...
  Future<Map<String, dynamic>> loginMobile({
    ...
    debugPrint('[ApiService] loginMobile - email: $email');
    ...
    try {
      ...
      debugPrint('[ApiService] loginMobile - Response status: ${response.statusCode}');
  ...
  /// 회원탈퇴
  /// DELETE /litten/note/v1/members/signup
  /// {"id": "bgso777@naver.com"}
  /// Response: {"result": 1} (1=성공, 기타=실패)
  Future<void> deleteAccount({
    ...
    try {
      final url = Uri.parse('$baseUrl$_deleteAccountEndpoint');
      final body = jsonEncode({
        'id': email,
      });

      debugPrint('[ApiService] deleteAccount - URL: $url');
      debugPrint('[ApiService] deleteAccount - Request body: $body');
      ...
      debugPrint('[ApiService] deleteAccount - Response status: ${response.statusCode}');
      debugPrint('[ApiService] deleteAccount - Response body: ${response.body}');
      ...
      if (response.statusCode == 200) {
        ...
        debugPrint('[ApiService] deleteAccount - Failed: ${response.statusCode}');
