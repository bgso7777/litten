...
echo "========================================"
echo "backend 계정 Java & Tomcat 설치 시작"
echo "========================================"
echo ""

echo "[1/5] backend 사용자 계정 생성 중..."
echo "----------------------------------------"
...
echo "  - 사용자명: $BACKEND_USER"
echo "  - 비밀번호: $BACKEND_PASSWORD"
echo "  - 홈 디렉토리: $BACKEND_HOME"
echo ""
...
echo "다운로드 URL: $TOMCAT_DOWNLOAD_URL"
...
echo "✓ Tomcat 설치 완료"
echo "  - 설치 경로: $BACKEND_HOME/tomcat"
echo ""
