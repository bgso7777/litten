...
# Flutter 클론 (stable 브랜치)
echo "Flutter 다운로드 중... (5-10분 소요)"
su - $NOTE_USER -c "git clone https://github.com/flutter/flutter.git -b stable $FLUTTER_DIR"

# 3.9.3 태그로 체크아웃
echo "Flutter 3.9.3 버전으로 변경 중..."
su - $NOTE_USER -c "cd $FLUTTER_DIR && git fetch --all --tags && git checkout $FLUTTER_VERSION"
