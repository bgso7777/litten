...
/** 메시지의 수신자별 전달. 메시지 1건당 1~N개(룸이면 멤버 수). */
@Getter
@Setter
@Entity(name = "RoomMessageDelivery")
@Table(name = "note_room_message_delivery")
@NoArgsConstructor
public class RoomMessageDelivery extends BaseEntity implements Serializable {
