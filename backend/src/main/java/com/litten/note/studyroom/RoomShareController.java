...
/**
 * 룸 학습자료 공유 API. 로그인 회원 전용.
 *  POST   /note/v1/room-shares                          공유 생성 (multipart)
 *  GET    /note/v1/room-shares/received                 받은 공유 목록
 *  GET    /note/v1/room-shares/sent                     보낸 공유 목록
 *  POST   /note/v1/room-shares/deliveries/{id}/accept   수락
 *  POST   /note/v1/room-shares/deliveries/{id}/reject   거절
 *  DELETE /note/v1/room-shares/{shareId}                취소(발신자 회수)
 *  GET    /note/v1/room-shares/{shareId}/download       다운로드(수락자)
 * (구경로 /note/v1/shares 병행 노출 — 구버전 앱 호환)
 */
@Log4j2
@RestController
...
public class RoomShareController {
    ...
    private final RoomShareService shareService;

    @CrossOrigin(origins = "*", allowedHeaders = "*")
    @PostMapping({"/note/v1/room-shares", "/note/v1/shares"})
    ...
    @CrossOrigin(origins = "*", allowedHeaders = "*")
    @GetMapping({"/note/v1/room-shares/lookup", "/note/v1/shares/lookup"})
    ...
    @CrossOrigin(origins = "*", allowedHeaders = "*")
    @GetMapping({"/note/v1/room-shares/received", "/note/v1/shares/received"})
    ...
    @CrossOrigin(origins = "*", allowedHeaders = "*")
    @GetMapping({"/note/v1/room-shares/sent", "/note/v1/shares/sent"})
    ...
    @CrossOrigin(origins = "*", allowedHeaders = "*")
    @PostMapping({"/note/v1/room-shares/deliveries/{deliveryId}/accept", "/note/v1/shares/deliveries/{deliveryId}/accept"})
    ...
    @CrossOrigin(origins = "*", allowedHeaders = "*")
    @PostMapping({"/note/v1/room-shares/deliveries/{deliveryId}/reject", "/note/v1/shares/deliveries/{deliveryId}/reject"})
    ...
    @CrossOrigin(origins = "*", allowedHeaders = "*")
    @DeleteMapping({"/note/v1/room-shares/{shareId}", "/note/v1/shares/{shareId}"})
    ...
    @CrossOrigin(origins = "*", allowedHeaders = "*")
    @GetMapping({"/note/v1/room-shares/{shareId}/download", "/note/v1/shares/{shareId}/download"})
