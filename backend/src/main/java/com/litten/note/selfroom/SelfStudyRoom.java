...
/** '나만의 스터디룸'(1인 룸) — 회원별로 여러 개 생성. 룸 안에 텍스트/파일 항목을 쌓는다. 기기 간 동기화용. */
@Getter
@Setter
@Entity(name = "SelfStudyRoom")
@Table(name = "note_self_study_room")
@NoArgsConstructor
public class SelfStudyRoom extends BaseEntity implements Serializable {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "id", columnDefinition = "BIGINT(20) NOT NULL AUTO_INCREMENT COMMENT '나만의 스터디룸 ID'")
    private Long id;
