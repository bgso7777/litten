...
/** 공유의 수신자별 전달/응답. 공유 1건당 1~N개(그룹이면 멤버 수). */
@Getter
@Setter
@Entity(name = "FileShareDelivery")
@Table(name = "note_file_share_delivery")
@NoArgsConstructor
public class FileShareDelivery extends BaseEntity implements Serializable {
