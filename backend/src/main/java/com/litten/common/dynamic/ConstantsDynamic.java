...
public class ConstantsDynamic {
    ...
    public static final String SERVICE_DYNAMIC_BASE_PACKAGE = "com.litten.common.dynamic.";
    ...
    public static final Integer RESULT_NOT_FOUND = 0;
    ...
    public static final Integer RESULT_ALEADY_EXIST = 2;
    public static final String RESULT_ALEADY_EXIST_MESSAGE = "이미 존재함.";
    public static final String RESULT_FAIL_MESSAGE = "알 수 없는 에러";
    public static final Integer RESULT_NOT_SUPPORT_SERVICE = -2;
    public static final String RESULT_NOT_SUPPORT_SERVICE_MESSAGE = "지원되지 않는 클래스";
    public static final Integer RESULT_NOT_FOUND_JPA_REPOSITORY = -3;
    public static final String RESULT_NOT_FOUND_JPA_REPOSITORY_MESSAGE= "리포지토리 객체를 찾을 수 없음";
    public static final Integer RESULT_NO_SUCH_METHOD = -4;
    public static final String RESULT_NO_SUCH_METHOD_MESSAGE = "메소드를 찾을 수 없음.";
    public static final Integer RESULT_DOMAIN_CAST_ERROR = -5;
    public static final Integer RESULT_INSERT_METHOD = -6;
    public static final Integer RESULT_UPDATE_METHOD = -7;
    public static final Integer RESULT_NOT_ALLOWED_INSERT_ERROR = -8;
    public static final String RESULT_NOT_ALLOWED_INSERT_ERROR_MESSAGE = "저장 허락되지 않은 클래스의 변수";
    public static final Integer RESULT_NOT_ALLOWED_UPDATE_ERROR = -9;
    public static final String RESULT_NOT_ALLOWED_UPDATE_ERROR_MESSAGE = "업데이트 허락되지 않은 클래스의 변수";
    public static final Integer RESULT_AUTH_TOKEN_ROLE_ERROR = -10;
    public static final Integer RESULT_DATA_DECRYPT_ERROR = -11;
    public static final Integer RESULT_OBJECT_TYPE_CAST_ERROR = -12;
    public static final Integer RESULT_DELETE_METHOD = -13;

    public static final Integer RESULT_GROUP_BY_ERROR = -11;
    public static final Integer RESULT_SOLUTION_TYPE_ERROR = -12;
    public static final Integer RESULT_STATUS_CODE_ERROR = -13;
    public static final Integer RESULT_FROM_FORMAT_ERROR = -14;
    public static final Integer RESULT_TO_FORMAT_ERROR = -15;
    public static final Integer RESULT_FROM_TO_RANGE_ERROR = -16;

    public static final Integer RESULT_REQUEST_DATA_ERROR = -21;
    public static final String RESULT_REQUEST_DATA_ERROR_MESSAGE = "요청 파라미터를 오류.";
    public static final Integer RESULT_FORMAT_ERROR = -22;
    public static final String RESULT_FORMAT_ERROR_MESSAGE = "포멧 오류.";
    public static final Integer RESULT_DATA_ERROR = -23;
    public static final String RESULT_DATA_ERROR_MESSAGE = "요청 데이터 오류.";
    public static final Integer RESULT_VOICEGATEWAY_ERROR = -24;
    public static final String RESULT_VOICEGATEWAY_ERROR_MESSAGE = "voicegateway에서 에러가 발생했습니다.";
    public static final Integer RESULT_DATA_SIZE_ERROR = -25;
    public static final String RESULT_DATA_SIZE_ERROR_MESSAGE = "요청 데이터 크기 오류 (row 사이즈 초과) ";
    public static final Integer RESULT_DAY_SIZE_ERROR = -26;
    public static final String RESULT_DAY_SIZE_ERROR_MESSAGE = "요청일 크기 오류 (요청일 초과) ";
    public static final Integer RESULT_DATE_SIZE_ERROR = -27;
    public static final String RESULT_DATE_SIZE_ERROR_MESSAGE = "일자 오류 ";
    public static final Integer RESULT_TARGET_LIST__ERROR = -28;
