...
//        .requestMatchers("/", "/changepassword1.html", "/changepassword2.html", "/changepassword3.html").permitAll()
//        .requestMatchers("/", "litten/changepassword1.html", "litten/changepassword2.html", "litten/changepassword3.html").permitAll()
//        .requestMatchers("/litten", "/changepassword1.html", "/changepassword2.html", "/changepassword3.html").permitAll()
//        .requestMatchers("/litten/changepassword1.html", "/litten/changepassword2.html", "/litten/changepassword3.html").permitAll()
//        .requestMatchers("/litten/**").permitAll()
//        .requestMatchers("/litten", "/*.html").permitAll()
//        .requestMatchers("/", "/*.html").permitAll()
//        .requestMatchers("/*.html", "/*.css", "/*.js", "/*.png", "/*.jpg", "/*.ico").permitAll()

//        //
//        .requestMatchers("/*.html").permitAll()
//        .requestMatchers("/changepassword1.html").permitAll()
//        .requestMatchers("/changepassword2.html").permitAll()
//        .requestMatchers("/changepassword3.html").permitAll()
//        .requestMatchers("/changepassword*.html").permitAll()
//
//        //
//        .requestMatchers("/litten/*.html").permitAll()
//        .requestMatchers("/litten/changepassword1.html").permitAll()
//        .requestMatchers("/litten/changepassword2.html").permitAll()
//        .requestMatchers("/litten/changepassword3.html").permitAll()
//        .requestMatchers("/litten/changepassword*.html").permitAll()
        ...
        // 캘린더 일정 동기화 API (로그인 회원 전용 — 게스트 차단. 프리미엄 무관)
        .requestMatchers("/note/v1/schedules", "/note/v1/schedules/**").hasAnyAuthority(
                AuthoritiesConstants.MEMBER_INDIVIDUAL, AuthoritiesConstants.MEMBER_INDIVIDUAL_MASTER,
                AuthoritiesConstants.MEMBER_COMPANY, AuthoritiesConstants.MEMBER_COMPANY_MASTER,
                AuthoritiesConstants.MEMBER_ADMIN_ADMIN)
        // 회원 인증 필요 API (로그인 전용 — 게스트 차단)
        .requestMatchers("/note/v1/members/me", "/note/v1/members/plan", "/note/v1/members/migrate",
                "/note/v1/members/logout", "/note/v1/members/devices")
                .hasAnyAuthority(
                AuthoritiesConstants.MEMBER_INDIVIDUAL, AuthoritiesConstants.MEMBER_INDIVIDUAL_MASTER,
                AuthoritiesConstants.MEMBER_COMPANY, AuthoritiesConstants.MEMBER_COMPANY_MASTER,
                AuthoritiesConstants.MEMBER_ADMIN_ADMIN)
...
//    }
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.addAllowedOriginPattern("*"); // credentials=true 시 addAllowedOrigin("*") 대신 사용
