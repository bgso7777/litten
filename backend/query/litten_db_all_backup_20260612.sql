...
) ENGINE=InnoDB AUTO_INCREMENT=60 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='클라우드 파일';

-- 내보낼 데이터가 선택되어 있지 않습니다.

-- 테이블 litten7.cloud_file_backup 구조 내보내기
DROP TABLE IF EXISTS `cloud_file_backup`;
...
) ENGINE=InnoDB AUTO_INCREMENT=3108 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='클라우드 파일 백업';

-- 내보낼 데이터가 선택되어 있지 않습니다.

-- 테이블 litten7.note_channel_watch_state 구조 내보내기
DROP TABLE IF EXISTS `note_channel_watch_state`;
...
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='회원';
...
DROP TABLE IF EXISTS `note_member_youtube_channel`;
CREATE TABLE IF NOT EXISTS `note_member_youtube_channel` (
  ...
  `remind_type` varchar(32) DEFAULT NULL,
  `remind_custom_count` int(11) DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=184 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='프롬프트 관리 (요약/리마인드, system/user 통합)';

-- 내보낼 데이터가 선택되어 있지 않습니다.

-- 테이블 litten7.note_prompt_config_copy 구조 내보내기
DROP TABLE IF EXISTS `note_prompt_config_copy`;
...
-- 테이블 litten7.note_remind_result 구조 내보내기
DROP TABLE IF EXISTS `note_remind_result`;
CREATE TABLE IF NOT EXISTS `note_remind_result` (
  ...
  `update_date_time` timestamp NULL DEFAULT NULL ON UPDATE current_timestamp() COMMENT '수정일시',
  PRIMARY KEY (`sequence`) USING BTREE,
  KEY `idx_remind_result_summary` (`summary_result_id`) USING BTREE,
  KEY `idx_remind_result_group` (`summary_result_id`,`group_order`,`sort_order`) USING BTREE,
...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='캘린더 일정 (로그인 회원 단위)';
...
CREATE TABLE IF NOT EXISTS `note_summary_result` (
  ...
  `total_remind_count` int(11) NOT NULL DEFAULT 0 COMMENT '리마인드 총 세부항목 수 (빠른 조회용)',
...
) ENGINE=InnoDB AUTO_INCREMENT=38 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='파일별 요약/리마인드 처리 결과';
